                    ...
                    tooltip: {
                        ...
                        callbacks: {
                            label: function (context) {
                                const showLabel = options.showLabelInTooltip !== false;
                                const valueText = new Intl.NumberFormat('vi-VN').format(context.parsed.y) + ' cái';
                                if (!showLabel || !context.dataset.label) {
                                    return valueText;
                                }
